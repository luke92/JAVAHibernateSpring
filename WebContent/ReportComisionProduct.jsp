...
<title>Reporte de Comisiones por ventas por Producto</title>
...
<body>
    ...
    <div class="jumbotron">
      <div class="container">
        <h1>Reporte de Comisiones por ventas por Producto</h1>
      </div>
    </div>
	
		<div class="container">
			<div class="col-lg-4">
				<form action="ReportComisionProduct" method="post">
					...
					<div class="form-group">
			    		...
			    		<button type="submit" value="edit" class="btn btn-primary">Listar Comisiones</button>
					</div>
				</form>
			</div>
			<div class="table-responsive">
			<c:if test="${not empty producto}">
				<h3>Producto ${producto.descripcion} Adicional ${producto.adicional}</h3>
